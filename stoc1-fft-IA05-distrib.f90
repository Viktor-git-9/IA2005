...
!
   ...
   CHARACTER(*), PARAMETER :: savePath1 = '/home/viktor/Dokumente/Doktor/ENS_BRGM/Code/IA2005/output/' ! use this save path for the model output
   CHARACTER(*), PARAMETER :: savePath2 = '/home/viktor/Dokumente/Doktor/ENS_BRGM/Code/IA2005/kernels/' ! use this save path to store and load the Green's function kernel files once they are calculated
...
105                  format(2i5, 1x, f9.3, i10, 1x, f9.3)
               ...
               call write_real_3DArray_bin(vel*alpha, savePath1//name100) ! multiply slip velos with alpha
